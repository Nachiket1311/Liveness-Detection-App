...
class IdentifyActivity : AppCompatActivity(), FrameInferface {
    ...
    private var currentCameraLens = CameraSelector.LENS_FACING_FRONT // Default to front camera

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_identify)

        val isProcMode = 1 // 0: Register, 1: Verify, 2: Liveness Test
